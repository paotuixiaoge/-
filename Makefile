...
export KBUILD_EXTRA_SYMBOLS += $(BSP_MODULES_OUT)/lct_tp/Module.symvers
export KBUILD_EXTRA_SYMBOLS += $(BSP_MODULES_OUT)/xiaomi_touch/Module.symvers
export KBUILD_EXTRA_SYMBOLS += $(BSP_MODULES_OUT)/../display/dispc/Module.symvers
#export KBUILD_EXTRA_SYMBOLS += $(BSP_KERNEL_OUT)/Module.symvers
#export KBUILD_EXTRA_SYMBOLS += $(BSP_MODULES_OUT)/adaptive-ts/Module.symvers
